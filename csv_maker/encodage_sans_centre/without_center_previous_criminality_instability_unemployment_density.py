...
query = """
    SELECT 
    encodage_sans_centre_gagnant as prediction,
    encodage_sans_centre_gagnant_precedent as precedent,
    criminality_per_cir.code_circonscription as code_circonscirption,
    taux_pour_mille, taux_chomage, density, instabilite_sans_centre,
    poids_nuance_sans_centre, desir_changement_sans_centre 
