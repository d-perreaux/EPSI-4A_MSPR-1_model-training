...
query = """
    ...
    taux_pour_mille, taux_chomage, density, instabilite_sans_centre, poids_nuance_sans_centre, desir_changement_sans_centre 
...
X = df[['precedent', 'taux_pour_mille', 'taux_chomage', 'density', 'instabilite_sans_centre', 'poids_nuance_sans_centre', 'desir_changement_sans_centre']]
y = df.prediction
labels = [1, 2, 3, 4]
