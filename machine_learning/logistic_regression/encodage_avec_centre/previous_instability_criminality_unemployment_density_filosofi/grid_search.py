...
query = """
    ...
    INNER JOIN statistiques_circonscriptions 
        ON legislative_per_cir.code_de_la_circonscription = statistiques_circonscriptions.code_de_la_circonscription
        AND legislative_per_cir.annee = statistiques_circonscriptions.annee_legislative
...
X = df[[
    ...
    'ratio_menages_en_maisons',
    'ratio_menages_en_logements_sociaux',
    'ratio_menages_pauvres',
    'ratio_individus_18_24',
    'ratio_individus_65_79'
]]
